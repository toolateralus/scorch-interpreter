...
fn arrays() {
    ...
    let t3 = ctx.variables["single_float_explicit"].clone();
    match &t3.value {
        Value::Array(_, elements) => {
    ...
    let t4 = ctx.variables["plural_float_implicit"].clone();
    match &t4.value {
        Value::Array(_, elements) => {
    ...
    let t5 = ctx.variables["plural_float_explicit"].clone();
    match &t5.value {
        Value::Array(_, elements) => {
    ...
    let t6 = ctx.variables["assignment"].clone();
    match &t6.value {
        Value::Array(_, elements) => {
    ...
    let t7 = ctx.variables["accessor_assignment"].clone();
    match &t7.value {
        Value::Array(_, elements) => {
